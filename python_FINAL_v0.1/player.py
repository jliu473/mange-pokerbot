...
class Player(Bot):
    ...
    def get_action(self, game_state, round_state, active):
        ...
        if my_contribution == 1: # always min raise as small blind
        ...
        if RaiseAction in legal_actions:
            raise_ammt, raise_cost = self.calc_raise(street, strength, pot, my_pip, continue_cost, min_raise, max_raise)
    ...
    def calc_raise(self, street, strength, pot, my_pip, continue_cost, min_raise, max_raise):
        if street < 3:
